...
if (isset($_GET['sql']) && $_GET['sql'] != ''){
	...
	$reponse=$bdd->query("SELECT LOGIN, STATUT, IP, DATE_CONNEXION, ACTION FROM connexion");
}
...
<page backtop='35mm' footer="date;heure;page;">
	...
	<hr>
                    ...
                    <h3 align="center">LOGS DES CONNEXIONS ET DECONNEXIONS DU SYSTEME</h3>
	...
	<table id="table" margin-top style="font-size: 10px; width: all;" align="center">
		   ...
		   <tbody>	
            <?php while ($donnees = $reponse->fetch()){  ?>
                <tr class="odd gradeX">
                    <td><?php echo $donnees['DATE_CONNEXION']; ?></td>
                    <td><?php echo $donnees['LOGIN']; ?></td>
                    <td><?php if ($donnees['STATUT'] == 1) {echo "Succès";} else {echo "Echec";}; ?></td>
...
try {
	...
	$pdf->Output("Logs des connexions et déconnexions.pdf");
