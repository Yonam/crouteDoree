...
if (isset($_GET['sql']) && $_GET['sql'] != ''){
	...
	$reponse=$bdd->prepare("SELECT * FROM produit order by code_produit");
	$reponse->execute();
}
	...
	<table id="table" margin-top style="font-size: 8px; width: all;" align="center">
	       ...
	       <thead>
				<tr>
					...
					<th style="width: unset;">Soumis TVA</th> 
					<th style="width: unset;">Commercialisé le</th>
					<th style="width: unset;">Enregistré le</th>
					<th style="width: unset;">Date de mise à jour</th>
					<th style="width: unset;">Quantité en stock</th>
					<th style="width: unset;">Prix produit</th>
				</tr>
		  </thead>
		   ...
		   <tbody>	
              	<?php while ($donnees = $reponse->fetch()){  ?>
                    <tr class="odd gradeX">
                        ...
                        <td style="width: unset;"><?php echo $donnees['SOUMIS_TVA']; ?></td>
                        <td style="width: unset;"><?php echo $donnees['DATE_COMMERCIALISATION']; ?></td>
						<td style="width: unset;"><?php echo $donnees['DATE_ENREGISTREMENT']; ?></td>
                        <td style="width: unset;"><?php echo $donnees['DATE_MJ']; ?></td>
