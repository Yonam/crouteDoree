...
if (isset($_GET['sql']) && $_GET['sql'] != ''){
	...
	$reponse=$bdd->query("SELECT code_com,nom_com,prenom_com,date_emb,tel_com, tel_urg, chiffre, pourcentage FROM commerciale where deleted = 0");
}
...
<page backtop='35mm' footer="date;heure;page;">
	...
	<hr>
                    ...
                    <h3 align="center" >CHIFFRE D'AFFAIRE DES COMMERCIAUX</h3>
...
try {
	...
	$pdf->Output("Chiffre d'affaire des commerciaux.pdf");
