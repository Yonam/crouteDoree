...
<page backtop='35mm' footer="date;heure;page;">
	...
	<hr>
                    ...
                    <h3 align="center" >RÉCAPITULATIF DES ENCAISSEMENTS</h3>
		   ...
		   <tbody>	
                  <?php while ($donnees = $reponse->fetch()){  ?>
                    <tr class="odd gradeX">
                        ...
                        <td>
                    	<?php if ($donnees['NOM_CLI'] != null && $donnees['PRENOM_CLI'] != null) {
                            echo $donnees['NOM_CLI'].' '.$donnees['PRENOM_CLI'];
                        }else{
                            echo "COMPTOIR";
                        }  ?> 
                    	</td>        
...
try {
	...
	$pdf->Output("Récapitulatif des encaissements.pdf");
