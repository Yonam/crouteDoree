	...
	<table id="table" margin-top >
	       ...
	       <thead>
			<?php while ($donnees1 = $vente1->fetch()){  ?>
	       	<tr>
	       		<th colspan="2"  style="width:100%; height:7%; border:none; text-align:center; font-size: 10px; padding-top: unset;">
			...
			<tr></tr>
		       	...
		       	<tr>
		       		<th colspan="2" style="width:100%; height:1px; padding-bottom: auto; margin: none; border: none; text-align:center; font-size: 13px;">
