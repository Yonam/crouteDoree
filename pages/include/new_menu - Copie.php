...
$menu = ' <li class="dropdown">
    ...
    <!-- /.dropdown-user -->
	 ...
	 <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <i class="fa fa-dashcube fa-fw"></i> ETATS STATISTIQUES <i class="fa fa-caret-down"></i>
            </a>
            <ul class="dropdown-menu dropdown-user">
    			<li><a href="?page=tableau_recap_ticket"> <i class="fa fa-bookmark fa-fw"></i> Tickets Vente</a></li>

                <li><a href="?page=tableau_recap_produit_enrg"> <i class="fa fa-medkit fa-fw"></i> Produits Enregistrés</a></li>
                
                <li><a href="?page=tableau_recap_compte"> <i class="fa fa-table fa-fw"></i> Situation Compte</a></li>

                <li><a href="?page=recap_journee"> <i class="fa fa-calendar-plus-o fa-fw"></i> Recap Journée</a></li>
